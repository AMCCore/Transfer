...
namespace Transfer.Dal.Migrations
{
    ...
    [Migration("20220316184350_TripRequest_1")]
    partial class TripRequest_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transfer.Dal.Entities.DbTripRequest", b =>
                {
                    b.HasOne("Transfer.Dal.Entities.DbOrganisation", "Сharterer")
                        .WithMany("TripRequests")
                        .HasForeignKey("СhartererId");

                    b.Navigation("Сharterer");
                });
