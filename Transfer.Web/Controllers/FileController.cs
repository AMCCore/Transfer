...
public class FileController : BaseController
{
    ...
    private static readonly Dictionary<string, string> static_lib = new()
    {
        ...
        { "ibh87t", "Оферта о заключении договора фрахтования транспортных средств для перевозки пассажиров и багажа с использованием Платформы.docx" },
        { "4ks6wz", "Соглашение об использовании Платформы.docx" }
    };
